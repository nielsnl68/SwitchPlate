...
class DisplayBuffer {
 public:
  ...
  /// fill a partion of the screen with the given array of colors.
  virtual void fill(int x1, int y1, int x2, int y2, uint16_t * pixels);
  uint32_t get_areasize(int x1, int y1, int x2, int y2)
{
    uint32_t size;
